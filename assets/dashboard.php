        ...
        foreach($dados as $dado){
          echo '<li>
                  <div class="product-image">
                    <img src="..\imgs/'.$dado['imagem'].'" layout="responsive" width="164" height="145" alt="'.$dado['nome'].'" />
                  </div>
                  <div class="product-info">
                    <div class="product-name"><span>'.$dado['nome'].'</span></div>
                    <div class="product-price"><span class="special-price">9 available</span> <span>'.$dado['preco'].'</span></div>
                  </div>
                </li>';
        }
      ?>
