        ...
        foreach($dados as $key => $dado){
          ...
          <tr class="data-row">
            <td class="data-grid-td">
              <span class="data-grid-cell-content">'.$dado['nome'].'</span>
            </td>
          
            <td class="data-grid-td">
              <span class="data-grid-cell-content">'.$dado['sku'].'</span>
            </td>

            <td class="data-grid-td">
              <span class="data-grid-cell-content">'.$dado['preco'].'</span>
            </td>

            <td class="data-grid-td">
              <span class="data-grid-cell-content">'.$dado['quantidade'].'</span>
            </td>

            <td class="data-grid-td">';
            foreach($prodSql->getProdutosCategorias($dado['sku']) as $cat){
              echo '<span class="data-grid-cell-content">'.$cat['nome'].'</span><br>';
            }  
            ...
            <td class="data-grid-td">
              <div class="actions">
                <div class="action edit"><a href="editProduct.php?sku='.$dado['sku'].'"><span>Edit</span></a></div>
                <div class="action delete"><a href="..\productsController.php?sku='.$dado['sku'].'&act=delete"><span>Delete</span></a></div>
              </div>
            </td>
          </tr>
          ';
