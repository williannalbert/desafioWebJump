      ...
      <?php
        ...
        echo '
          <tr class="data-row">
            ...
            <td class="data-grid-td">
              <span class="data-grid-cell-content">'.$dado['Id'].'</span>
            </td>
          
            <td class="data-grid-td">
              <div class="actions">
                <div class="action edit"><a href="editCategory.php?id='.$dado['Id'].'"><span>Edit</span></a></div>
                <div class="action delete"><a href="..\categoriesController.php?id='.$dado['Id'].'&act=delete"><span>Delete</span></a></div>
              </div>
            </td>
          </tr>
        ';
