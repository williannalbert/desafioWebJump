...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form action="..\categoriesController.php" method="post">
      ...
      <div class="input-field">
        ...
        <input type="text" id="category-code" class="input-text" name="category-code"/>
        
      </div>
      <div class="actions-form">
        <a href="categories.php" class="action back">Back</a>
        <input class="btn-submit btn-action"  type="submit" value="Save" name="save" />
      </div>
    </form>
  </main>
  <!-- Main Content -->
